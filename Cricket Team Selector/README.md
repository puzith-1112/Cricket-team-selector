...
**Why not pure Greedy?**
Greedy picks the locally best player (highest rating/cost ratio) but can miss the globally optimal combination. For example, two mid-rated players may together provide more value than one expensive star within the same budget.

**Why 0/1 Knapsack?**
Each player can only be selected once (0 or 1 times), and we need the globally optimal combination — exactly what 0/1 Knapsack DP solves.
